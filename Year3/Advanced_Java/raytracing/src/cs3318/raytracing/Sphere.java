...
class Sphere implements Renderable {
    ...
    /**
     * Check if a Ray object intersects with the objects in the scene.
     *
     * @param ray - Ray object used to see if there is intersections.
     */
    ...
    public String toString() { return ("sphere " + center + " " + radius);
    }
}